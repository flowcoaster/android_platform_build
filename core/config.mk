...
# Remove -Wpointer-arith switch to avoid complaints about pointer arithmetic in flowcoaster
COMMON_GLOBAL_CFLAGS:= -DANDROID -fmessage-length=0 -W -Wall -Wno-unused -Winit-self
